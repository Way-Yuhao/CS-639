...
search_radius = 41;     % Half size of the search window
template_radius = 9;   % Half size of the template window
...
search_radius = 19;     % Half size of the search window
template_radius = 9;   % Half size of the template window
grid_MN = [12, 10];        % Number of rows and cols in the grid
...
% tracking_params.rect = [195 62 43 131];

% Half size of the search window
tracking_params.search_radius = 20;
