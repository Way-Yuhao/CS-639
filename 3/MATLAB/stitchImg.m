...
%               get you started.
    ...
    canvas_width_height = [W_stitched, H_stitched];
    ...
    for n = 1:num_imgs
        ...
        [inliers_id, H] = runRANSAC(kp_n, kp_stitched, 1000, 2);
        [mask, dest_img] = backwardWarpImg(img_n, inv(H), canvas_width_height);
        % Superimpose the image
        stitched_img = blendImagePair(dest_img, mask, stitched_img, stitch_mask,'blend');
        stitch_mask = mask | stitch_mask;
        % ---------------------------------------
